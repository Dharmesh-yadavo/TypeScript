...
const userIn = (val: number | boolean | string): number | boolean | string => {
...
const combineUserAndAccount = (userz: Users, account: Account) => {
  return { ...userz, ...account };
};

const personInfo: Users & Account = combineUserAndAccount(userz, account);
