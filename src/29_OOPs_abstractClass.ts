//Abstract classes provide a way to define common properties and methods that multiple derived classes
// can share. This promotes code reuse and helps establish a common interface for related classes.

// abstract class cannot be instantiated
// abstract classes focus on class inheritance and sharing common functionality, whereas the
// useContext hook in React focuses on managing global state and allowing components to consume that state.
...
//? Suppose you're building a graphics application, and you want to create a hierarchy of different shapes.
...
class Circle extends Shape {
  ...
  public displayArea = () => {
    return console.log(
      `This is a ${this.color} circle with radius ${this.radius}.`
    );
  };
}
...
class Rectangle extends Shape {
  ...
  public displayArea = () => {
    return console.log(
      `This is a ${this.color} reactangle with Area ${this.clculateArea()}.`
    );
  };
}
class Square extends Shape {
  ...
  public displayArea = () => {
    return console.log(
      `This is a ${this.color} square with area ${this.clculateArea()}.`
    );
  };
}
